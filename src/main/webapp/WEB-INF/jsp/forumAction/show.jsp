...
<html>
<head>
    <title>【${forum.fName}】中的主题列表</title>
...
<div id="Title_bar">
    <div id="Title_bar_Head">
        ...
        <div id="Title"><!--页面标题-->
            <img border="0" width="13" height="13" src="${pageContext.request.contextPath }/style/images/title_arrow.gif"/> 【${forum.fName}】中的主题列表
        </div>
    ...
    <center>
        <div class="ItemBlock_Title1" style="width: 98%;">
            ...
            <span style="margin-left:30px;">
                <s:a action="topic_addUI?fId=%{#forum.fId}">
                ...
                <s:iterator value="#topics">
                    <tr height="35" id="d0" class="template">
                        ...
                        <td class="ForumTopicPageDataLine" align="center">
                            <img src="${pageContext.request.contextPath }/style/images/topicType_${type}.gif"/></td>
                        <td class="Topic">
                            <s:a action="topic_show?id=%{id}" cssClass="Default">${title}</s:a>
                        </td>
                        <td class="ForumTopicPageDataLine">
                            <ul class="ForumPageTopicUl">
                                <li class="Author">${author.uName}</li>
                                <li class="CreateTime">
                        ...
                        <td class="ForumTopicPageDataLine">
                            <ul class="ForumPageTopicUl">
                                <li class="Author">${lastReply.author.uName}</li>
                                <li class="CreateTime">
                                    <s:date name="lastReply.postTime" format="yyyy-MM-dd HH:mm:ss"/></li>
                            </ul>
                        </td>
                        <td></td>
                    </tr>
