        ...
        <div class="ItemBlock_Title1"><!-- 信息说明 -->
            <div class="ItemBlock_Title1">
                <img border="0" width="4" height="7"
                     src="${pageContext.request.contextPath }/style/blue/images/item_point.gif"/> 正在为【${role.rName}】配置权限
            </div>
        </div>
            ...
            <div class="ItemBlock">
                <table cellpadding="0" cellspacing="0" class="mainForm">
                    ...
                    <tr class="TableDetail1">
                        ...
                        <td>
                                <%--对语法不熟、显示树状结构改起来麻烦--%>
                                <%--<s:checkboxlist name="pIds" list="#privileges" listKey="pId" listValue="pName" value="%{pIds}"></s:checkboxlist>--%>
                            <ul id="tree">
                                    <%--顶级菜单--%>
                                <s:iterator value="#topPrivileges">
                                <li>
                                    <input type="checkbox" name="pIds" value="${pId}" id="cb_${pId}"
                                        <s:property value="%{pId in pIds ? 'checked' : ''}"/>>
                                    <label for="cb_${pId}"><span class="folder">${pName}</span></label>
                                        <%--第二级菜单--%>
                                    <ul>
                                            ...
                                            <ul>
                                                <s:iterator value="children">
                                                    <li>
                                                        <input type="checkbox" name="pIds" value="${pId}" id="cb_${pId}"
                                                            <s:property value="%{pId in pIds ? 'checked' : ''}"/>>
                                                        <label for="cb_${pId}"><span
                                                                class="folder">${pName}</span></label>
                                                    </li>
                                                </s:iterator>
                                                </li>
                                            </ul>
