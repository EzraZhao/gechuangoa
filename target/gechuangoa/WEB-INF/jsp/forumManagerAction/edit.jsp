...
<!--显示表单内容-->
<div id="MainArea">
    <s:form action="forumManager_%{fId == null ? 'add' : 'update'}">
            ...
            <div class="ItemBlock">
                <table cellpadding="0" cellspacing="0" class="mainForm">
                    <tr>
                        ...
                        <td>
                            <s:textfield name="fName" cssClass="InputStyle required"/> *
                        </td>
                    </tr>
                    <tr>
                        <td>版块说明</td>
                        <td>
                            <s:textarea name="fDescription" cssClass="TextareaStyle"></s:textarea></td>
                    </tr>
                </table>
            </div>
        </div>
