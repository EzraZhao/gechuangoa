        ...
        <center>
            <div class="ItemBlock_Title1">
                <div width=85% style="float:left">
                    ...
                    <font class="MenuPoint"> &gt; </font>
                    <s:a action="forum_show?id=%{#topic.forum.id}">${topic.forum.fName}</s:a>
                    <font class="MenuPoint"> &gt;&gt; </font>
                    帖子回复
                </div>
            </div>
            <div class="ItemBlockBorder">
                <table border="0" cellspacing="1" cellpadding="1" width="100%" id="InputArea">
                    ...
                    <tr>
                        ...
                        <td class="InputAreaBg">
                            <div class="InputContent">
                                <s:textfield name="title" cssClass="InputStyle" style="width:100%"
                                    ...
                                    <tr>
                                        ...
                                        <td width="50" style="border-bottom:0 solid #ffffff">
                                            ...
                                            <label for="r_${num}"><img width="19" height="19"
                                                                  src="${pageContext.request.contextPath }/style/images/face/face${num}.gif" align="absmiddle"
                                                                  disabled="true"/></label>
                                        </td>
                                        </s:iterator>
                                    </tr>
                    ...
                    <tr height="240">
                        ...
                        <td class="InputAreaBg">
                            <div class="InputContent">
                                <s:textarea name="content" cssStyle="width: 650px; height: 200px;"></s:textarea></div>
                        </td>
                    </tr>
                    <tr height="30">
